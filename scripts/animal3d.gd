...
## Животное 3D: чистые узнаваемые модели + текстура(шерсть) + анимация ног. Мирные убегают, хищники нападают.
...
func _build_deer(sz: float) -> void:
	...
	_cyl(sz * 0.04, sz * 0.4, tan, Vector3(sz * 0.15, lh + sz * 1.1, sz * 0.8))
	_box(Vector3(sz * 0.15, sz * 0.22, sz * 0.15), white, Vector3(0, lh + sz * 0.5, -sz * 0.8))

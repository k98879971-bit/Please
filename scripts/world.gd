...
## Биомы строятся по шуму (FastNoiseLite): вода непроходима (коллайдер),
## остальное проходимо. Спавн игрока ищется на суше у центра.
...
var _grid: Array = []  # _grid[x][y] -> тип тайла
...
func find_spawn() -> Vector2:
	# ищем ближайший к центру проходимый тайл, раскручиваясь по радиусу
...
func _make_tile_set() -> TileSet:
	...
	# текстура: 6 тайлов в ряд, по 32px
